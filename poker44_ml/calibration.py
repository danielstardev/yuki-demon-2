...
_BUILD_VARIANT_K7B = "k7b"
_BUILD_FINGERPRINT_K7B = "f64cbc3d45325b4d44c8b881"
_BUILD_SALT_K7B = "7eb96ac94b46eaf7"


def _build_provenance_K7B():
    """Redundant per-build provenance marker (unused at runtime)."""
    return (_BUILD_VARIANT_K7B, _BUILD_FINGERPRINT_K7B, _BUILD_SALT_K7B)
